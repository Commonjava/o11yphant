...
import org.commonjava.o11yphant.metrics.reporter.zabbix.util.HostUtil;
                ...
                extends ScheduledReporter
{
    ...
    private final DefaultZabbixSender indyZabbixSender;
    ...
    public static class Builder
    {
        ...
        private DefaultZabbixSender indyZabbixSender;
        ...
        public Builder zabbixSender( DefaultZabbixSender indyZabbixSender )
        {
         ...
         */
        public ZabbixReporter build( DefaultZabbixSender zabbixSender )
        {
            if ( hostName == null )
            {
            ...
            return new ZabbixReporter( registry, name, rateUnit, durationUnit, filter, zabbixSender, hostName,
                                       prefix, suffix );
        }
    }

    private ZabbixReporter( MetricRegistry registry, String name, TimeUnit rateUnit, TimeUnit durationUnit,
                            MetricFilter filter, DefaultZabbixSender indyZabbixSender, String hostName,
